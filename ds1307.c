...
void init_ds1307(void)
{
	...
	write_ds1307(SEC_ADDR, dummy | 0x80); //disable the oscillator

	/* Seting 12 Hr Format */
	dummy = read_ds1307(HOUR_ADDR);
	write_ds1307(HOUR_ADDR, dummy | 0x40);  //set the format by making the bit as 1
...
{
	i2c_start();
	i2c_write(SLAVE_WRITE); // unique id
